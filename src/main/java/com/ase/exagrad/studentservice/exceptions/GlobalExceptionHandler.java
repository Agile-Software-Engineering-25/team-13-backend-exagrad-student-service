...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleStorage(
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
            .body(ApiResponse.error("File storage operation failed", 
                request.getRequestURI(), HttpStatus.INTERNAL_SERVER_ERROR, error));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleMaxUploadSize(
        ...
        return ResponseEntity.status(HttpStatus.PAYLOAD_TOO_LARGE)
            .body(ApiResponse.error("File too large", request.getRequestURI(), 
                HttpStatus.PAYLOAD_TOO_LARGE, error));
    }
